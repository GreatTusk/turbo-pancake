...
//             constants::name::player::nodes::respawn_sfx);
//
...
//         }
//         else if (vel.y < 0.0 &&
//                  animated_sprites->get_animation() !=
...
//             godot::D_METHOD(constants::name::player::signals::dying_sfx_finished),
//             &Player::_on_dying_sfx_finished);
//         godot::ClassDB::bind_method(
//             godot::D_METHOD(constants::name::player::signals::respawn_finished),
//             &Player::_on_respawn_animation_finished);
//         // From external nodes
//         godot::ClassDB::bind_method(
//             godot::D_METHOD(constants::name::player::signals::world_border, "body"),
